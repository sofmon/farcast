...
| 3.2 (next) | SDK wiring (`farcast.Storage()` → `Store`) on [ADR 0008](../docs/adr/0008-in-cluster-key-delivery.md)'s sealed-by-default keyholder; SDK error sentinels including `ErrStorageSealed` |
