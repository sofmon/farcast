...
All (proposed); the reasoning is in [ADR 0012](../docs/adr/0012-allthing-private-inference-first.md).
...
- The decisions and their decision space — [ADR 0012](../docs/adr/0012-allthing-private-inference-first.md)
