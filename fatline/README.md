...
fatline/
├── README.md                       ← this file
├── Containerfile                   ← the deployable data-plane image (distroless, non-root; built/pushed for `connect`, 2.3)
